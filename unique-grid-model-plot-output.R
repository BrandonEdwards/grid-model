...
for (regions in 1:70)
{
  temp.data<-read.csv(paste("C:/Users/Brandon/Documents/GitHub/grid-model/Unique Grid Plots/", regions, " parameter estimates.csv", sep=""))
...
for (param in param.list)
{
  ...
  png(paste("C:/Users/Brandon/Documents/GitHub/grid-model/Unique Grid Plots/output/", param, "_by_Zone.png", sep=""), width=960, height=960)
  print(p1)
  dev.off()
} 
